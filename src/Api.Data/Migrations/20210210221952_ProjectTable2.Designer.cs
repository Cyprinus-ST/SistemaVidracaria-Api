...
namespace Api.Data.Migrations
{
    ...
    [Migration("20210210221952_ProjectTable2")]
    partial class ProjectTable2
    {
            ...
            modelBuilder.Entity("Api.Domain.Entities.Plan.PlanEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2021, 2, 10, 19, 19, 52, 392, DateTimeKind.Local).AddTicks(6261),
                            Description = "Plano Experimental",
                            Installments = 0.0,
                            Name = "Plano Experimental",
                            Status = "Ativo",
                            UpdateAt = new DateTime(2021, 2, 10, 19, 19, 52, 392, DateTimeKind.Local).AddTicks(6269)
                        },
                        new
                        {
                            Id = new Guid("d96bc3ad-4584-44b4-b370-7d0ef8132732"),
                            CreateAt = new DateTime(2021, 2, 10, 19, 19, 52, 392, DateTimeKind.Local).AddTicks(6477),
                            Description = "Plano Experimental",
                            Installments = 0.0,
                            Name = "Plano Experimental",
                            Status = "Ativo",
                            UpdateAt = new DateTime(2021, 2, 10, 19, 19, 52, 392, DateTimeKind.Local).AddTicks(6479)
                        });
                });
            ...
            modelBuilder.Entity("Api.Domain.Entities.User.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2021, 2, 10, 19, 19, 52, 390, DateTimeKind.Local).AddTicks(2789),
                            Email = "lucas.vilas@email.com",
                            Name = "Administrador",
                            Password = "123456",
                            UpdateAt = new DateTime(2021, 2, 10, 19, 19, 52, 391, DateTimeKind.Local).AddTicks(3313)
                        });
                });
