...
namespace Api.Data.Migrations
{
    ...
    [Migration("20210210222041_ProjectTable_Correta")]
    partial class ProjectTable_Correta
    {
            ...
            modelBuilder.Entity("Api.Domain.Entities.Plan.PlanEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2021, 2, 10, 19, 20, 41, 150, DateTimeKind.Local).AddTicks(3021),
                            Description = "Plano Experimental",
                            Installments = 0.0,
                            Name = "Plano Experimental",
                            Status = "Ativo",
                            UpdateAt = new DateTime(2021, 2, 10, 19, 20, 41, 150, DateTimeKind.Local).AddTicks(3030)
                        },
                        new
                        {
                            Id = new Guid("f8e58981-c111-450e-bff7-d169a3b363a9"),
                            CreateAt = new DateTime(2021, 2, 10, 19, 20, 41, 150, DateTimeKind.Local).AddTicks(3250),
                            Description = "Plano Experimental",
                            Installments = 0.0,
                            Name = "Plano Experimental",
                            Status = "Ativo",
                            UpdateAt = new DateTime(2021, 2, 10, 19, 20, 41, 150, DateTimeKind.Local).AddTicks(3251)
                        });
                });
            ...
            modelBuilder.Entity("Api.Domain.Entities.User.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2021, 2, 10, 19, 20, 41, 147, DateTimeKind.Local).AddTicks(9428),
                            Email = "lucas.vilas@email.com",
                            Name = "Administrador",
                            Password = "123456",
                            UpdateAt = new DateTime(2021, 2, 10, 19, 20, 41, 148, DateTimeKind.Local).AddTicks(9566)
                        });
                });
