...
namespace Api.Data.Migrations
{
    ...
    [Migration("20210210221608_ProjectTable")]
            ...
            modelBuilder.Entity("Api.Domain.Entities.Plan.PlanEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2021, 2, 10, 19, 16, 7, 646, DateTimeKind.Local).AddTicks(1105),
                            Description = "Plano Experimental",
                            Installments = 0.0,
                            Name = "Plano Experimental",
                            Status = "Ativo",
                            UpdateAt = new DateTime(2021, 2, 10, 19, 16, 7, 646, DateTimeKind.Local).AddTicks(1121)
                        },
                        new
                        {
                            Id = new Guid("819c4405-447c-44f2-aa78-d970486d5c0c"),
                            CreateAt = new DateTime(2021, 2, 10, 19, 16, 7, 646, DateTimeKind.Local).AddTicks(1374),
                            Description = "Plano Experimental",
                            Installments = 0.0,
                            Name = "Plano Experimental",
                            Status = "Ativo",
                            UpdateAt = new DateTime(2021, 2, 10, 19, 16, 7, 646, DateTimeKind.Local).AddTicks(1376)
                        });
                });
            ...
            modelBuilder.Entity("Api.Domain.Entities.User.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2021, 2, 10, 19, 16, 7, 643, DateTimeKind.Local).AddTicks(6666),
                            Email = "lucas.vilas@email.com",
                            Name = "Administrador",
                            Password = "123456",
                            UpdateAt = new DateTime(2021, 2, 10, 19, 16, 7, 644, DateTimeKind.Local).AddTicks(7225)
                        });
                });
